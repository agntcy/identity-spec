...
The `Identity Spec` maintainers take all security issues in the project
seriously. Thank you for improving the security of `Identity Spec`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`Identity Spec` leverages GitHub's private vulnerability reporting.
